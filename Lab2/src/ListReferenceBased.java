...
public class ListReferenceBased implements ListInterface {
  ...
  public void displayList() {
    ...
    for (currentNode = head; currentNode != null; currentNode = currentNode.getNext()) {
      String curr = currentNode.getItem();
  ...
  public void listLargest() {
    Node curr = head;
    Integer largest = (int)0;
    Integer current = (int)0;

    for (curr = head; curr != null; curr = curr.getNext()) {
      current = (Integer) curr.getItem();
      if(current > largest){
        largest = current;
      }
    }
    System.out.println("Largest Item is : " + largest.intValue());
  }
}